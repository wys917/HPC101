...
请有意向选课的同学完成 Lab 1 (MiniCluster) 实验并提交实验报告，如果你实在没有时间完成实验，也可以提交个人简介。同时我们也提供了 Lab 0 (Linux Crash Course) 实验，帮助你快速上手 Linux 系统，你可以根据自身情况选择完成，并将实验结果一并提交。
...
- **截止时间**：具体时间待定，初步定于第一次选课截止时，请关注群内通知。

我们会优先考虑实验完成度高的同学，而且实验本身是作为小学期的一次作业使用的。欢迎大家踊跃报名！
